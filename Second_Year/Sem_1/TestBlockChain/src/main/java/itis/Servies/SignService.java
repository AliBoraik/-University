...
public class SignService {
    ...
    private void readKeys() throws IOException {
        ...
        BufferedReader read = new BufferedReader(new FileReader("src/main/java/itis/Keys/privateKey.txt"));
        privateKey = read.readLine();

        read = new BufferedReader(new FileReader("src/main/java/itis/Keys/publicKey.txt"));
